class ImageArtefactsController < ApplicationController
  ...
  def new
    @image_artefact = ImageArtefact.new
  end
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to image_artefacts_url, notice: 'image_artefact was successfully destroyed.' }
  ...
  def set_image_artefact
    @image_artefact = ImageArtefact.find(params[:id])
  end

  def image_artefact_params
    params.require(:image_artefact).permit(:image_file)
  end
